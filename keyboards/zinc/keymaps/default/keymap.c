...
[_QWERTY] = LAYOUT_ortho_4x12(
  ...
  [_LOWER] = LAYOUT_ortho_4x12( \
      ...
      _______, _______, _______, _______, _______, _______,                   KC_MINS, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
   ...
   */
    [_ADJUST] =  LAYOUT_ortho_4x12( \
      ...
      _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, AG_NORM,                   AG_SWAP, KC_MINS, KC_EQL,  KC_PSCR, KC_SLCK, _______,\
      _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, _______,                   _______, _______, _______, _______, _______, KC_PAUS,\
